...
DWORD WINAPI WDLoopProc( LPVOID lpParameter)
{
    ...
    CMOOSRemoteMod* pMe =     (CMOOSRemoteMod*)lpParameter;
...
CMOOSRemoteMod::CMOOSRemoteMod()
{
    m_dfCurrentElevator    =    0;
    m_dfCurrentRudder    =    0;
    m_dfCurrentRotation    =    0;
    m_bQuit = true;
...
bool CMOOSRemoteMod::StopThreads()
{
    m_bQuit = true;
...
bool CMOOSRemoteMod::StartThreads()
{
    m_bQuit = false;
...
bool CMOOSRemoteMod::Run( const char * sName,
...
//            return false;
    ...
    while(!m_bQuit)
    {
        ...
        case 'z':
            m_dfCurrentRotation -= 0.5;
            if(m_dfCurrentRotation<=-17.5)
            {
                m_dfCurrentRotation=-17.5;
            }
            MOOSTrace("Setting Rotation to %7.3f\n",m_dfCurrentRotation);
            break;
...
bool CMOOSRemoteMod::SendDesired()
{
    m_Lock.Lock();
    if(m_Comms.IsConnected())
    {
        if(m_bManualOveride)
        {
            ...
            m_Comms.Notify("DESIRED_ROTATION",m_dfCurrentRotation);
...
bool CMOOSRemoteMod::MakeCustomKeys()
{
    STRING_LIST sParams;
...
bool CMOOSRemoteMod::OnConnectToServer()
{
...
bool CMOOSRemoteMod::SetManualOveride(bool bOveride)
{
...
bool CMOOSRemoteMod::HitInputWD()
{
    m_dfTimeLastAck = MOOSTime();
    return true;
}

bool CMOOSRemoteMod::DoCustomJournal(char cCmd)
{
...
bool CMOOSRemoteMod::DoCustomKey(char cCmd)
{
...
bool CMOOSRemoteMod::EnableMailLoop(bool bEnable)
{
    m_bRunMailLoop = bEnable;
    return true;
}

bool CMOOSRemoteMod::DoNavSummary(CMOOSMsg &Msg)
{
...
bool CMOOSRemoteMod::PrintNavSummary()
{
    STRING_LIST ToPrint;
...
bool CMOOSRemoteMod::ReStartAll()
{
    char Confirm;
...
bool CMOOSRemoteMod::MakeCustomJournals()
{
...
bool CMOOSRemoteMod::MakeCustomSummary()
{
...
bool CMOOSRemoteMod::PrintCustomSummary()
{
    ostringstream os;
