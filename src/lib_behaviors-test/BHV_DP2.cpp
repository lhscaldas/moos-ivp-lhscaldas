...
BHV_DP2::BHV_DP2(IvPDomain gdomain) : 
  IvPBehavior(gdomain)
{
...
bool BHV_DP2::setParam(string param, string val) 
{
  param = tolower(param);
...
IvPFunction *BHV_DP2::onRunState() 
{
...
void BHV_DP2::postStationMessage(bool post)
{
...
void BHV_DP2::updateHibernationState()
{
  if(m_pskeep_state == "disabled")
    return;  
...
bool BHV_DP2::historyShowsProgressStart()
{
...
bool BHV_DP2::historyShowsProgressEnd()
{
  double oldest_dist = m_distance_history.back();
  double newest_dist = m_distance_history.front();
...
void BHV_DP2::handleVisualHint(string hint)
{
...
void BHV_DP2::postConfigStatus()
{
  string str = "type=BHV_DP2,name=" + m_descriptor;
