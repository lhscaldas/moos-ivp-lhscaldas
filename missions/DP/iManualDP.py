...
class iManualDP(pymoos.comms):

    def __init__(self, moos_community, moos_port):
        """Initiates MOOSComms, sets the callbacks and runs the loop"""
        super(iManualDP, self).__init__()
        ...
        self.p3d = "PSV4500.p3d"
        self.my_dyna = pydyna.create_simulation(self.p3d)
        self.my_vessel = self.my_dyna.vessels['207']
        ...
        self.my_dp = inhousedp.InhouseDP("/home/lhscaldas/moos-ivp-lhscaldas/missions/DP/"+self.p3d, 207)
...
def main():
    DPcontrol = iManualDP('localhost', 9000)
    DPcontrol.iterate()
